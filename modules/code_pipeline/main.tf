...
resource "aws_codebuild_project" "app02-iac_build" {
  name          = "app02-iac-codebuild"
  build_timeout = "10"
...
resource "aws_codepipeline" "pipeline" {
  ...
  stage {
    ...
    action {
      ...
      configuration = {
        ...
        Repo       = "app02-iac"
        Branch     = "master"
        OAuthToken = "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"
      }
    }
  }
  ...
  stage {
    ...
    action {
      ...
      configuration = {
        ProjectName = "app02-iac-codebuild"
      }
    }
  }
